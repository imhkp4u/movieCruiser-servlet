...
public class MoviesDaoCollectionImpl implements MoviesDao {
	...
	public MoviesDaoCollectionImpl() {
		...
		if (movieList == null) {
			...
			Movies itemOne = new Movies(1L, "Avatar", 2787965087L, true, 
			...
			Movies itemThree = new Movies(3L, "Titanic", 2187463944L, true,
					new DateUtil().convertToDate("21/08/2020"), "Romance", false);

			Movies itemFour = new Movies(4L, "Jurassic World", 1671713208L, false,
					new DateUtil().convertToDate("02/07/2017"), "Science Fiction", true);

			Movies itemFive = new Movies(5L, "Avengers", 2750760348L, true,
